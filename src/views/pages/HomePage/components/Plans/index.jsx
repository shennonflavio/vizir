    ...
    <Container>
      ...
      <WrapperPlans>
       ...
       <BoxPlans key={index}>
          ...
          <ContractButton
          onClick={items.plan === 'Personalizado' ?  ()=> scrollCalc() : ()=> navigate('/contract')}
          type='button'>{items.plan === 'Personalizado' ?  'Customizar': 'Contratar' }</ContractButton>
       </BoxPlans>))}
      </WrapperPlans>
    </Container>);
}
